...
print("\nPig is a two-player dice game in which each person rolls a die.")
...
print("\nYou go first. Type 'r' to roll the die.")
...
if computer_points >= 100: #if computer has enough points to win
    print("\nThe computer has scored", computer_points, "points and has won the game. Better luck next time.")
elif user_points >= 100: #if user has enough points to win
    print("\nCongratulations! You have scored", user_points, "points and have won the game!")
