...
# Code copied from Brickbuster: Sound related stuff (Play and Stop were found in Visual Studio and I just guessed to see if they would work and they did!)
# Rotation code given during office hours (Thanks Prate!). I tried using these though first: https://docs.unity3d.com/ScriptReference/Transform-eulerAngles.html https://docs.unity3d.com/ScriptReference/Transform-rotation.html 
